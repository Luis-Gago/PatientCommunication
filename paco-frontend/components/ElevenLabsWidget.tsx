    ...
    <div className="flex flex-col h-full bg-gradient-to-b from-purple-50 to-white">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-4 shadow-lg">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold">PaCo</h1>
      ...
      <div className="p-6 bg-gradient-to-b from-blue-50 to-white border-b border-blue-100">
        <div className="max-w-md mx-auto">
          <h2 className="text-lg font-bold text-blue-900 mb-4 text-center">How to Use PaCo</h2>
          <div className="space-y-3">
            <div className="flex gap-3">
              ...
              <p className="text-sm text-gray-700 pt-1">
                Click <strong>"Call PaCo"</strong> button in the bottom right corner
              </p>
            </div>
            <div className="flex gap-3">
              <div className="flex-shrink-0 w-8 h-8 bg-purple-600 text-white rounded-full flex items-center justify-center font-bold">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        {!scriptLoaded && (
          <div className="text-center text-gray-500">
            ...
            <p className="text-lg font-medium">Loading PaCo...</p>
