...
Added three new columns to the `vera_conversations` table:
...
**Error:** `column "provider" of relation "vera_conversations" already exists`
...
**Solution:** Make sure you're in the vera-api directory and venv is activated:
```bash
cd vera-api
