# PaCo API - Multi-User FastAPI Backend

A FastAPI-based backend for the PaCo P.A.D. educational chatbot, supporting multiple simultaneous users with research ID authentication.
...
4. **Chat Session** → Real-time streaming with PaCo
