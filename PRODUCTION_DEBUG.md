...
**Railway Backend:** `paco.up.railway.app`
**WebSocket URL:** `wss://paco.up.railway.app/api/v1/chat/ws/chat`
...
```
https://paco.up.railway.app/health
```
